...
namespace Manage.Repository.Migrations
{
    ...
    [Migration("20201026105118_add first email sent field to listing table")]
    partial class addfirstemailsentfieldtolistingtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manage.Repository.Entities.Listing", b =>
                {
                    ...
                    b.Property<bool>("FirstEmailSent");
            ...
            modelBuilder.Entity("Manage.Repository.Entities.UserProfileType", b =>
                {
                    b.Property<string>("UserProfileId");

                    b.Property<int>("UserTypeId");

                    b.HasKey("UserProfileId", "UserTypeId");

                    b.HasIndex("UserTypeId");

                    b.ToTable("UserProfileTypes");
                });
            ...
            modelBuilder.Entity("Manage.Repository.Entities.UserProfileType", b =>
                {
                    b.HasOne("Manage.Repository.Entities.UserProfile", "UserProfile")
                        .WithMany("UserProfileTypes")
                        .HasForeignKey("UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Manage.Repository.Entities.UserType", "UserType")
                        .WithMany("UserProfileTypes")
